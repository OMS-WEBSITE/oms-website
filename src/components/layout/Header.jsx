...
const Header = () => {
  ...
  return (
    <>
      {/* Header */}
      <header className="sticky top-0 left-0 w-full bg-white backdrop-blur-md border-b border-gray-100 shadow-sm z-50">
        <div className="container mx-auto max-w-7xl px-4 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            ...
            <button
              className="md:hidden flex items-center justify-center p-2 rounded-md border border-gray-200 hover:bg-orange-50 transition-all duration-300"
