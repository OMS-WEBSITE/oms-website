...
//                   isPaused ? "bg-white/5" : "bg-white/10"
//                 } backdrop-blur-md`}
//               >
//                 <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-6 z-20 transform -translate-y-10 md:-translate-y-16">
//                   <h2 className="text-2xl md:text-4xl font-semibold leading-relaxed max-w-2xl mb-3">
//                     Run your lab on the cloud - secure, scalable, and compliant.
//                   </h2>
//                   <p className="text-lg md:text-xl max-w-2xl text-gray-200">
...
//         }
//         .animate-smoothFadeUp {
//           animation: smoothFadeUp 1.5s ease-out forwards;
//         }
//       `}</style>
//     </section>
//   );
